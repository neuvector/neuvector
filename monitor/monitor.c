...
#define ENV_MAX_SCANNERS_PER_CONTROLLER            "MAX_SCANNERS_PER_CONTROLLER"
...
static pid_t fork_exec(int i)
{
    ...
    char *max_scanner_tasks, *max_concurrent_repo_scan_tasks, *max_scanners_per_controller, *scan_job_queue_capacity, *scan_job_fail_retry_max, *repo_scan_long_poll_timeout, *stale_scan_job_cleanup_interval_hour;
    int a;
...
*/
        ...
        if ((max_scanners_per_controller = getenv(ENV_MAX_SCANNERS_PER_CONTROLLER)) != NULL) {
            args[a++] = "-max_scanners_per_controller";
            args[a++] = max_scanners_per_controller;
        }
