...
func StartRESTServer(isNewCluster bool, isLead bool) {
	...
	r.GET("/v1/system/alerts", handlerSystemGetAlerts)   // skip API document
...
func IsCertNearExpired(certPath string, expireThreshold time.Duration) (bool, error) {
